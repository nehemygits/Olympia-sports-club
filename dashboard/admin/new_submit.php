...
$query="insert into users(username,gender,mobile,email,dob,joining_date) values('$uname','$gender','$phn','$email','$dob','$jdate')";
        ...
        if($result){
          ...
          if(mysqli_query($con,$query2)==1){
            ...
            if(mysqli_query($con,$query4)==1){
              ...
              $query5="insert into address(id,streetName,county,city,zipcode) values('$memID','$stname','$county','$city','$zipcode')";
