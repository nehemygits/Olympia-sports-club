       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
            ...
            <tr>
               <td height="35">COUNTY:</td>
               <td height="35"><input type="text" name="county" id="boxx" required/ size="30"></td>
             </tr>
            <tr>
        	...
        	function myplandetail(str){
        		...
        		if(str==""){
           		 ...
           		 // code for IE7+, Firefox, Chrome, Opera, Safari
       			 	...
       			 	xmlhttp.onreadycountychange = function() {
            		if (this.readycounty == 4 && this.status == 200) {
